...
coco_format_save_path='../datasets/Exdark_json/val'                      #要生成的标准coco格式标签所在文件夹
yolo_format_classes_path='./classes.txt'     #类别文件，一行一个类
yolo_format_annotation_path='../datasets/Exdark/labels/val'        #yolo格式标签所在文件夹
img_pathDir='../datasets/Exdark/images/val'                        #图片所在文件夹
...
name = coco_format_save_path+'.json'
